...
then
  C:/D/VISUAL~1/VISUAL~1/product/Common7/IDE/COMMON~1/MICROS~1/CMake/Ninja/ninja.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/D/VISUAL~1/VISUAL~1/product/Common7/IDE/COMMON~1/MICROS~1/CMake/Ninja/ninja.exe $targets_to_make 
fi
exit $?
