...
then
  C:/D/visualstudio/Visual Studio 2026/product/Common7/IDE/CommonExtensions/Microsoft/CMake/Ninja/ninja.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/D/visualstudio/Visual Studio 2026/product/Common7/IDE/CommonExtensions/Microsoft/CMake/Ninja/ninja.exe $targets_to_make 
fi
exit $?
